...
def smart_nframes(
    ...
    if  nframes > total_frames:   #changed
        nframes = total_frames #changed
    if not (FRAME_FACTOR <= nframes and nframes <= total_frames) and nframes != 1:
